...
function buildLocalAgentResult(task, mode = "intake", history = [], previousResult) {
                ...
                configureServer(server) {
                    server.middlewares.use("/api/agent", async (req, res) => {
                        ...
                        try {
                            ...
                            const response = await postJson("https://open.bigmodel.cn/api/paas/v4/chat/completions", {
